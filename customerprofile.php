...
?>
    ...
    <div class="col-xs-19">
      <div class="form-areaa">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> CUSTOMERS PROFILE </h3>
...
<div class="table-responsive" >
  ...
  <body>
    <tr>
      ...
      <td class="text-center"><a href="customerprofile.php?id=<?php echo $row["customer_ID"]; ?>" onclick="display_remove()"><span class="text-danger">Remove</span></a><br></td>
    </tr>
  </body>
  ...
  <h4><center>NO CUSTOMERS</center> </h4>
