    ...
    <div class="container" >
        <div class="col-md-5" style="float: none; margin: 0 auto;">
            <div class="form-area">
                ...
                <br style="clear: both">
                <h3 class="contact"> REGISTER</h3>
          
        <form action="registersuccessful.php" method="POST">
 ...
 <div class="row">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="contact" type="text" name="contact" placeholder="Contact no." required="">
              <span class="input-group-btn">
        ...
        <div class="row">
          ...
          <p style="text-align: center;">Already have an account? <a href="customerlogin.php">Login</a></p>
        </form>
    </div>     
</div>      
</div>
